...
axis.plot(power_data[3], power_data[7], color="red", label="Reference")
axis.plot(power_data[3], power_data[5], color="green", label="Pre-FFT")
axis.plot(power_data[3], power_data[6], color="blue", label="Post-FFT")
axis.plot(power_data[3], 10**3 * power_data[6] / power_data[5], color="black", label="$10^3$ Post/Pre")
