...
axis.plot(power_data[2], power_data[5] * (1 + 1/np.sqrt(power_data[1])), "--", color="red")
axis.plot(power_data[2], power_data[5] * (1 - 1/np.sqrt(power_data[1])), "--", color="red")
axis.plot(power_data[2], power_data[5] * (1 + 2/np.sqrt(power_data[1])), "--", color="orange")
axis.plot(power_data[2], power_data[5] * (1 - 2/np.sqrt(power_data[1])), "--", color="orange")
axis.plot(power_data[2], power_data[3], color="black", label="Linear")
axis.plot(power_data[2], power_data[4], color="green", label="Second-order")
